...
// NOTE: /questions/reset MUST come before /questions/:id to avoid wildcard swallowing it
...
// Save teacher explanation/feedback for a media item
app.post("/media/:id/explanation", (req, res) => {
    const { explanation } = req.body;
    const media = mediaFiles.find(m => m.id === parseInt(req.params.id));
    ...
    media.explanation = explanation;
    res.json({ success: true, message: "Explanation saved", media });
});
