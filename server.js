...
2. SUBJECT-VERB AGREEMENT — singular/plural mismatch (he go, they was, it are, etc.)
3. ARTICLE ERRORS — missing 'a', 'an', 'the'; wrong article used; extra article where none needed
4. PREPOSITION ERRORS — wrong preposition (in/on/at/to/for/with/by), missing preposition, extra preposition
5. REPEATED MISTAKES — if the student makes the same error multiple times, list EACH occurrence as a separate error entry with its exact wrong phrase
6. SENTENCE STRUCTURE — wrong word order, incomplete sentences, run-on sentences, dangling clauses
7. PRONOUN ERRORS — wrong pronoun case (him/he, her/she), pronoun-antecedent mismatch
8. PLURAL/SINGULAR NOUN ERRORS — wrong plural form, uncountable noun used as countable
9. AUXILIARY VERB ERRORS — missing do/does/did, wrong modal (can/could/will/would/shall/should)
10. CONJUNCTIONS — missing conjunctions, wrong conjunction, comma splice
11. SPELLING/WORD CHOICE — wrong word used, incorrect vocabulary for context
12. DOUBLE NEGATIVES — using two negatives (I don't know nothing)
13. REDUNDANCY — unnecessary repeated words or phrases

SCORING RULES (be strict):
- 90-100: Near perfect, max 1 minor error
- 75-89: Good, 2-4 minor errors
- 60-74: Average, 5-7 errors or 1-2 major errors
- 40-59: Below average, many errors or serious structural problems
- 0-39: Poor, fundamental errors throughout

CRITICAL RULES:
- NEVER return empty errors array if there are mistakes
- NEVER merge two different instances of the same error — each wrong phrase is a separate object
- The "wrong" field must be the EXACT substring from the student's text
- The "corrected" field must fix ALL errors and be completely natural English
- If student text has 0 errors, return errors:[] and score:100

Respond ONLY with valid JSON, no markdown fences, no text before or after:
{"corrected":"fully corrected text","errors":[{"wrong":"exact wrong phrase","right":"correct replacement","rule":"grammar rule explanation","type":"Tense|Agreement|Article|Preposition|Structure|Pronoun|Noun|Auxiliary|Conjunction|WordChoice|Redundancy|Other"}],"score":0-100,"suggestions":["actionable tip 1","actionable tip 2","actionable tip 3"],"pronunciation_tips":["tip for Telugu/Kannada speakers"]}`;
